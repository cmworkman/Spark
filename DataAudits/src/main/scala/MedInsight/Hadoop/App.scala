...
object App {
  ...
  def main(arg: Array[String]): Unit = {
    ...
    //println("ABM Count :" + Audit_B_Member_Month_Enrollment_DF.count())
    //println("CSWS Count :" + Claims_Summary_W_SID_DF.count())
    ...
    println("Foundation Table Cnt:" + Foundation_Table.count() )
  }
